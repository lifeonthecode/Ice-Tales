        ...
        <div className='flex flex-col gap-4 p-4 bg-white shadow-lg rounded-lg'>
            <Link to={'/shop/product-details'}>
                ...
                <div className="flex flex-col items-center justify-center gap-4">
                    ...
                    <button to={'/cart'} className='max-w-[200px] w-full h-[44px] bg-[#f83d8e] rounded-2xl flex items-center justify-center text-lg text-white font-archivo font-bold capitalize gap-2 cursor-pointer'>add to cart <MdArrowRightAlt size={'1.5rem'} /> </button>
                </div>
            </Link>
        </div>
    );
