...
const ProductCard = ({ card, gridView }) => {
    return (
        <div className='flex flex-col gap-4 p-4 bg-white shadow-lg rounded-lg'>
            ...
            <div className="flex flex-col items-center justify-center gap-4">
                ...
                {
                    gridView === '1' && <p className='text-xl text-[#787878] font-archivo font-normal'>{card?.description}</p>
                }
                {
                    gridView === '1' && <span className='text-xl text-[#0f0200] font-archivo font-semibold capitalize'>stock: {card?.stock}</span>
                }
